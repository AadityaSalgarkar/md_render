...
export const THEME_VARS = [
  ...
  '--selection',
  '--shadow-fold',
  // Display math: the book themes set it in a tinted panel; the bare
  // web-page themes leave it on the page, as MathJax does.
  '--math-display-bg',
  '--math-display-padding',
  // Typography
  '--font-head',
  '--font-body',
  '--font-mono',
...
export const themes: ThemeDefinition[] = [
  {
    ...
    vars: {
      ...
      '--math-display-bg': 'var(--code-bg)',
      '--math-display-padding': '1em 1.5em',
  ...
  },
  {
    ...
    vars: {
      ...
      '--shadow-fold': '8px 0 24px -8px rgba(0, 0, 0, 0.12)',
      '--math-display-bg': 'transparent',
      '--math-display-padding': '0',
  ...
  {
    // The modern research-blog look: system sans on white, a violet accent
    // under links, Google Sans Code for code, and Catppuccin Macchiato code
    // colours.
    id: 'ponder',
    name: 'Ponder',
    mode: 'light',
    blurb: 'System sans on white with a violet accent; code in Google Sans Code.',
    swatch: ['#FFFFFF', '#8E7BD0', '#5E42BC'],
    vars: {
      '--bg-primary': '#FFFFFF',
      '--bg-secondary': '#F5F5F5',
      '--bg-editor': '#FFFFFF',
      ...
      '--accent': '#8E7BD0',
      '--accent-hover': '#5E42BC',
      '--accent-secondary': '#5E42BC',
      '--border': '#E6E6E6',
      '--border-strong': '#C8C8C8',
      '--code-bg': '#F5F5F5',
      '--selection': 'rgba(142, 123, 208, 0.2)',
      '--shadow-fold': '8px 0 24px -8px rgba(0, 0, 0, 0.12)',
      '--math-display-bg': 'transparent',
      '--math-display-padding': '0',
      '--font-head':
